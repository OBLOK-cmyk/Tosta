...
class VeniceMap extends StatefulWidget {
  @override
  _VeniceMapState createState() => _VeniceMapState();
}

class _VeniceMapState extends State<VeniceMap> {
  LatLng _currentLocation = LatLng(0, 0);
  final LatLng veniceGrandCanal = LatLng(14.5341, 121.0518);
  ...
  Future<void> _fetchRoute() async {
    ...
    final end = '${veniceGrandCanal.longitude},${veniceGrandCanal.latitude}';
