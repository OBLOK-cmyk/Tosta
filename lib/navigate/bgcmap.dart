...
class BGCMap extends StatefulWidget {
  @override
  _BGCMapState createState() => _BGCMapState();
}

class _BGCMapState extends State<BGCMap> {
  LatLng _currentLocation = LatLng(0, 0);
  final LatLng BGCMap = LatLng(14.5507,  121.0504); // Updated coordinates
  ...
  Future<void> _fetchRoute() async {
    ...
    final end = '${BGCMap.longitude},${BGCMap.latitude}';
