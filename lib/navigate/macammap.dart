...
class MacamMap extends StatefulWidget {
  @override
  _MacamMapState createState() => _MacamMapState();
}

class _MacamMapState extends State<MacamMap> {
  LatLng _currentLocation = LatLng(0, 0);
  final LatLng MacamMap = LatLng(14.541,  121.05); // Updated coordinates
  ...
  Future<void> _fetchRoute() async {
    ...
    final end = '${MacamMap.longitude},${MacamMap.latitude}';
