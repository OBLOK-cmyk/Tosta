...
class Macam extends StatefulWidget {
  final touristSpot1.TouristSpot spot;

  Macam({Key? key, required this.spot}) : super(key: key);

  @override
  _MacamPageState createState() => _MacamPageState();
}

class _MacamPageState extends State<Macam> {
